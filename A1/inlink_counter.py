...
if __name__ == '__main__':
        ...
        if file.endswith('.html'):
            ...
            if file_name in hash_link_dict:
                ...
                with open(os.path.join(path, file), 'r', encoding='utf-8') as f:
                    ...
                    outlink_dict[file_name] = num_outlinks  ###
            print(f'done with {file}')

    # print(inlink_dict)
    with open(os.path.join(path, 'inlink.csv'), 'w', encoding='utf-8') as f:
    ...
    with open(os.path.join(path, 'num_of_outlink.csv'), 'w', encoding='utf-8') as f:
        for key in outlink_dict:
            f.write(f'{key},{outlink_dict[key]}\n')
